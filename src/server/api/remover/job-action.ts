...
type RemoverApiContext = {
  parseParams(
    paramsPromise: Promise<unknown>,
    schema: typeof RemoverJobParamsSchema
  ): Promise<{ id: string }>;
};

type JobStatusActionDeps = {
  createApiContext: (req: Request) => RemoverApiContext;
