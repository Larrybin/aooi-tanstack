...
- `src/app/[locale]/(admin)/admin/payments/page.tsx`
- `src/app/[locale]/(admin)/admin/payments/replay/page.tsx`
...
- `src/app/[locale]/(landing)/(ai)/ai-audio-generator/page.tsx`
- `src/app/[locale]/(landing)/(ai)/ai-chatbot/page.tsx`
...
- `src/app/[locale]/(landing)/my-images/page.tsx`
