...
export type SiteI18nPages = z.infer<typeof siteI18nPagesSchema>;
export type SiteI18nManifest = z.infer<typeof siteI18nManifestSchema>;
export type SiteI18nPage = SiteI18nPages['pages'][number];
export type SiteI18nManifestEntry = SiteI18nManifest['locales'][string][string];
type SiteLike = {
...
export function parseSiteI18nPages(input: unknown): SiteI18nPages {
  return siteI18nPagesSchema.parse(input);
}

export function parseSiteI18nManifest(input: unknown): SiteI18nManifest {
  return siteI18nManifestSchema.parse(input);
}

function validateManifestLocales(manifest: SiteI18nManifest, site: SiteLike) {
...
function validateManifestPages(
...
export function validateSiteI18nPackage({
  pages,
  manifest,
  site,
}: {
